...
* [v4 · Multi-Provider AI + Retry](multi-provider-ai.md) - Reference for the multi-provider LLM client (Apple on-device, Gemini, OpenRouter, GLM), the model fallback chain, retry affordance, and per-card attribution.
